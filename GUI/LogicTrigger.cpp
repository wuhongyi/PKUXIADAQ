...
int LogicTrigger::load_info(Long_t mod)
{
  ...
  for (int i = 0; i < 16; i++)
    {
      ...
      if(retval < 0)
	std::cout<<"Error: LogicTrigger.cpp - Pixie16ReadSglChanPar - ExtTrigStretch"<<std::endl;      
      sprintf(text, "%1.2f", ChanParData);
      NumEntry[1][i]->SetText(text);

      retval = Pixie16ReadSglChanPar((char*)"ExternDelayLen", &ChanParData, mod, i);
      if(retval < 0)
	std::cout<<"Error: LogicTrigger.cpp - Pixie16ReadSglChanPar - ExternDelayLen"<<std::endl;            
      sprintf(text, "%1.2f", ChanParData);
      NumEntry[2][i]->SetText(text);

      retval = Pixie16ReadSglChanPar((char*)"FtrigoutDelay", &ChanParData, mod, i);
      if(retval < 0)
	std::cout<<"Error: LogicTrigger.cpp - Pixie16ReadSglChanPar - FtrigoutDelay"<<std::endl;            
      sprintf(text, "%1.2f", ChanParData);
      NumEntry[3][i]->SetText(text);

      retval = Pixie16ReadSglChanPar((char*)"VetoStretch", &ChanParData, mod, i);
      if(retval < 0)
	std::cout<<"Error: LogicTrigger.cpp - Pixie16ReadSglChanPar - VetoStretch"<<std::endl;            
      sprintf(text, "%1.2f", ChanParData);
  ...
  if(retval < 0)
    std::cout<<"Error: LogicTrigger.cpp - Pixie16ReadSglModPar - TrigConfig0"<<std::endl;        
  ...
  if(retval < 0)
    std::cout<<"Error: LogicTrigger.cpp - Pixie16ReadSglModPar - TrigConfig1"<<std::endl; 
  ...
  if(retval < 0)
    std::cout<<"Error: LogicTrigger.cpp - Pixie16ReadSglModPar - TrigConfig2"<<std::endl; 
...
int LogicTrigger::change_values(Long_t mod)
{
  ...
  for (int i = 0; i < 16; i++)
    {
      ...
      if(retval < 0) ErrorInfo("LogicTrigger.cpp", "change_values(...)", "Pixie16WriteSglChanPar/ExtTrigStretch", retval);
  
      ChanParData = NumEntry[2][i]->GetNumber();
      retval = Pixie16WriteSglChanPar((char*)"ExternDelayLen", ChanParData, mod, i);
      if(retval < 0) ErrorInfo("LogicTrigger.cpp", "change_values(...)", "Pixie16WriteSglChanPar/ExternDelayLen", retval);
  
      ChanParData = NumEntry[3][i]->GetNumber();
      retval = Pixie16WriteSglChanPar((char*)"FtrigoutDelay", ChanParData, mod, i);
      if(retval < 0) ErrorInfo("LogicTrigger.cpp", "change_values(...)", "Pixie16WriteSglChanPar/FtrigoutDelay", retval);
  
      ChanParData = NumEntry[4][i]->GetNumber();
      retval = Pixie16WriteSglChanPar((char*)"VetoStretch", ChanParData, mod, i);
      if(retval < 0) ErrorInfo("LogicTrigger.cpp", "change_values(...)", "Pixie16WriteSglChanPar/VetoStretch", retval);
  ...
  retval = Pixie16ReadSglModPar((char*)"TrigConfig0", &ModParData, mod);
  if(retval < 0) ErrorInfo("LogicTrigger.cpp", "change_values(...)", "Pixie16ReadSglModPar/TrigConfig0", retval);
  ...
  if(retval < 0) ErrorInfo("LogicTrigger.cpp", "change_values(...)", "Pixie16WriteSglModPar/TrigConfig0", retval);
  
  retval = Pixie16ReadSglModPar((char*)"TrigConfig1", &ModParData, mod);
  if(retval < 0) ErrorInfo("LogicTrigger.cpp", "change_values(...)", "Pixie16ReadSglModPar/TrigConfig1", retval);
  ...
  if(retval < 0) ErrorInfo("LogicTrigger.cpp", "change_values(...)", "Pixie16WriteSglModPar/TrigConfig1", retval);
  
  retval = Pixie16ReadSglModPar((char*)"TrigConfig2", &ModParData, mod);
  if(retval < 0) ErrorInfo("LogicTrigger.cpp", "change_values(...)", "Pixie16ReadSglModPar/TrigConfig2", retval);
